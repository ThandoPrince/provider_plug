...
class GetCostOfServiceImagesApi {
  ...
  static Future<List<CostOfServiceImageModel>>
      fetchImages(
    int costOfServiceId,
  ) async {
    final url = Uri.parse(
      "$baseUrl/cost-of-service/$costOfServiceId/images/",
    );
    ...
    try {
      ...
      return CostOfServiceImageModel.listFromJson(
