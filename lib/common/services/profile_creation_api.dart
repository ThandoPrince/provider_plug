  ...
  Future<Map<String, dynamic>> patchSPProfile({
    ...
    try {
      ...
      if (result["statusCode"] == 401) {
        ...
        if (kDebugMode) {
          print("ACCESS TOKEN: ${AuthSessionController.instance.accessToken}");
        }
if (kDebugMode) {
  print("REFRESH TOKEN: ${AuthSessionController.instance.refreshToken}");
}
if (kDebugMode) {
  print("EMAIL: ${AuthSessionController.instance.email}");
}
if (kDebugMode) {
  ...
  Future<Map<String, dynamic>> _sendRequest({
    ...
    final token = AuthSessionController.instance.accessToken;
