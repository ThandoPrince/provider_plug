...
// Assuming your brand colors are defined here
        ...
        child: InkWell(
          onTap: () async {
            if (_selectedService != null) {
              final controller = context.read<LinkServiceController>();
              ...
              if (success) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(controller.message ?? "Something went wrong"),
                  ),
                );
              }
            } else {
