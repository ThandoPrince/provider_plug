...
class SPUploadAffidavitScreen extends StatefulWidget {

  final String serviceId;

  const SPUploadAffidavitScreen({
  ...
  @override
  State<SPUploadAffidavitScreen> createState() => _SPUploadAffidavitScreenState();
}

class _SPUploadAffidavitScreenState extends State<SPUploadAffidavitScreen> {
  File? _selectedFile;
...
void initState() {
  ...
  FlushbarService.success(
    context,
    "Affidavit uploaded successfully. It is now awaiting verification.",
